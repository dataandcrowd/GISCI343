...
```python
df[df["pop23_ov65"] > 5000]
df[df["Name"] == "Waitemata Local Board Area"]

ov10m_old = df[(df["pop23_ov65"] > 5000) & (df["Name"] == "Waitemata Local Board Area") ]
...
* Assign a variable `over_5000` by filtering "2023 Census" and over 5000
:::
