...
```python
# 1. Store the Sky Tower coordinates
latitude = ____
longitude = ____

# 2. Create a formatted message
message = f"Sky Tower is at ({____}, {____})"
print(message)

# 3. Calculate distance from origin (simplified)
distance = (latitude**2 + longitude**2) ____ 0.5
...
::: {.fragment}
*Hint*: Sky Tower lat = -36.8485, lon = 174.7633. The missing operator raises to a power.
:::
...
* ChatGPT and Gemini (🧐)
* **Web book**: [pythongis.org](https://pythongis.org/)
