...
### We can see what the actual address of a variable we create is with id:

```python
x = 5 # first we can create a new variable, and give it the name 'x'

print ("The variable x =" +str(x)+ 
      " and this variable's physical memory address is "+str(id(x))) 
```
